param(
    [string]$Output = '',
    [string]$ClientSource = 'Client',
    [string]$ServerSource = 'Server',
    [string]$DatabaseSource = 'Database_Template\mysql'
)
...
Copy-PackageTree -Source $DatabaseSource -Destination (Join-Path $staging 'Database\mysql') -Patterns $mysqlExcludes
