...
function spell.onCastSpell(creature, variant)
	...
	if player and player.getElementalStance and player:getElementalStance() == STANCE_MASTER_OF_DECAY then
	...
	if player and player.setElementalStance and STANCE_MASTER_OF_DECAY then
