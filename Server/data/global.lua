...
local remasteredBootstrapFile = io.open(CORE_DIRECTORY .. "/remastered_bootstrap.lua", "r")
if remasteredBootstrapFile ~= nil then
	io.close(remasteredBootstrapFile)
	dofile(CORE_DIRECTORY .. "/remastered_bootstrap.lua")
end
