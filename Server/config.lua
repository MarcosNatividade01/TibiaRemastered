...
-- Free exploration bypasses access checks without completing quests or writing storages.
...
-- Remastered baseline keeps requirements effectively at one third without changing saved progress.
