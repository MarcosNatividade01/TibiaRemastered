...
keywordHandler:addKeyword({ "passage" }, StdModule.say, { npcHandler = npcHandler, text = "Where are we at the moment? This is Helheim!*HICKS* Where do you want to go? {Svargrond}, {Okolnir}, {Tyrsung} or the {Camp}?" })
