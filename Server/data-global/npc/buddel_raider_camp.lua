...
keywordHandler:addKeyword({ "passage" }, StdModule.say, { npcHandler = npcHandler, text = "Where are we at the moment? This is the Raider Camp!*HICKS* Where do you want to go? {Svargrond}, {Okolnir}, {Helheim} or {Tyrsung}?" })
